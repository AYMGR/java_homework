...
/**
 * *3.13 (Financial application: compute taxes) Listing 3.5, ComputeTax.java, gives the source code
  ...
  public static void main(String[] args) {
    ...
    if (status == 0) {  // Compute tax for single filers
      if (income <= 8350) {
        ...
        tax =
            8350 * 0.10 + (33950 - 8350) * 0.15 + (82250 - 33950) * 0.25 + (171550 - 82250) * 0.28 +
                (income - 171550) * 0.33;
      } else {
        tax =
            8350 * 0.10 + (33950 - 8350) * 0.15 + (82250 - 33950) * 0.25 + (171550 - 82250) * 0.28 +
      ...
      if (income <= 11950) {
        ...
        tax = 11950 * 0.1 + (45599 - 11950) * 0.15 + (117450 - 11950) * 0.25
            + (income - 117450) * 0.28;
      } else if (income <= 372950) {
        tax = 11950 * 0.1 + (45599 - 11950) * 0.15 + (117450 - 11950) * 0.25
